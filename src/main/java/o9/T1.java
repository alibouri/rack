...
import com.sendwave.shared.PayBillWithInvoicesDialogActivity;
...
public final class t1 implements Factory {
    ...
    public final n c;
    public final PayBillWithInvoicesDialogActivity d;

    public t1(R6 r60, PayBillDialogParams payBillDialogParams0, n n0, PayBillWithInvoicesDialogActivity payBillWithInvoicesDialogActivity0) {
        this.a = r60;
        this.b = payBillDialogParams0;
        this.c = n0;
        this.d = payBillWithInvoicesDialogActivity0;
    }
    ...
    public final ViewModel a(Class class0) {
        ...
        return new w1(this.a, this.b, this.c, c0, customerApp0.I0);
    }
