...
public abstract class j0 {
    ...
    static {
        ...
        Builder compiledField$Builder0 = new Builder("unpausePaymentCard", u4.a);
        j0.a = o.C(new CompiledArgument[]{o.r("idempotencyKey", new com.apollographql.apollo.api.CompiledArgument.Builder(i2.t1)), o.r("paymentCardId", new com.apollographql.apollo.api.CompiledArgument.Builder(i2.u1))}, compiledField$Builder0, list2);
    }
}
