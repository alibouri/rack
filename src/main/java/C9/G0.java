...
public abstract class g0 {
    ...
    static {
        ...
        Builder compiledField$Builder0 = new Builder("pausePaymentCard", r2.a);
        g0.a = o.C(new CompiledArgument[]{o.r("idempotencyKey", new com.apollographql.apollo.api.CompiledArgument.Builder(i2.r1)), o.r("paymentCardId", new com.apollographql.apollo.api.CompiledArgument.Builder(i2.s1))}, compiledField$Builder0, list2);
    }
}
