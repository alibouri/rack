...
public final class InterfaceType extends CompiledNamedType {
    public static final class Builder {
        ...
        public Builder(InterfaceType interfaceType0) {
            j.f(interfaceType0, "interfaceType");
            this(interfaceType0.getName());
            this.keyFields = interfaceType0.getKeyFields();
            this.implements = interfaceType0.getImplements();
            this.embeddedFields = interfaceType0.getEmbeddedFields();
        }
    ...
    public InterfaceType(String s, List list0, List list1, List list2) {
        j.f(s, "name");
        j.f(list0, "keyFields");
