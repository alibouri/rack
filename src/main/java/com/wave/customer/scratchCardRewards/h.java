...
public final class h implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel0) {
        ...
        return new KnownAward(s, s1, ((ServerDate)object1), v0, ((ScratchCardTermsAndConditions)object0), ((ScratchCard.Award.Known)parcel0.readParcelable(KnownAward.class.getClassLoader())));
    }

    @Override  // android.os.Parcelable$Creator
    public final Object[] newArray(int v) {
        return new KnownAward[v];
    }
}
