...
public final class l6 {
    ...
    public l6(String s, AnnouncementsFragment announcementsFragment0, CustomerAnnouncementsFragment customerAnnouncementsFragment0) {
        this.a = s;
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof l6)) {
            return false;
        }
        if(!j.a(this.a, ((l6)object0).a)) {
            return false;
        }
        return j.a(this.b, ((l6)object0).b) ? j.a(this.c, ((l6)object0).c) : false;
    }
