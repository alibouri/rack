...
public abstract class p {
    ...
    static {
        ...
        List list3 = q.L(new CompiledSelection[]{new Builder("__typename", CompiledGraphQL.-notNull(r1.a)).build(), new com.apollographql.apollo.api.CompiledFragment.Builder("CustomerAnnouncements", q.K("CustomerAnnouncements")).selections(O.a).build(), new com.apollographql.apollo.api.CompiledFragment.Builder("CustomerAnnouncements", q.K("CustomerAnnouncements")).selections(z.a).build()});
        p.a = q.L(new CompiledField[]{new Builder("id", CompiledGraphQL.-notNull(p1.a)).build(), new Builder("announcementsV3", CompiledGraphQL.-notNull(C.a)).selections(list2).build(), new Builder("customerAnnouncements", CompiledGraphQL.-notNull(A0.a)).selections(list3).build()});
    }
}
