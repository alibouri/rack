...
public abstract class t {
    ...
    static {
        ...
        t.a = q.L(new CompiledField[]{new Builder("id", CompiledGraphQL.-notNull(p1.a)).build(), new Builder("historyConnection", u1.a).arguments(q.K(new com.apollographql.apollo.api.CompiledArgument.Builder(Y4.a).value(20).build())).selections(list2).build()});
    }
}
