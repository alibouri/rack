...
public final class j extends A {
    ...
    public j(float f, float f1, float f2, float f3, float f4, float f5) {
        super(2, true, false);
        this.c = f;
        this.d = f1;
        this.e = f2;
    ...
    public final boolean equals(Object object0) {
        ...
        if(Float.compare(this.c, ((j)object0).c) != 0) {
            return false;
        }
        if(Float.compare(this.d, ((j)object0).d) != 0) {
            return false;
        }
        if(Float.compare(this.e, ((j)object0).e) != 0) {
            return false;
        }
        if(Float.compare(this.f, ((j)object0).f) != 0) {
            return false;
        }
        return Float.compare(this.g, ((j)object0).g) == 0 ? Float.compare(this.h, ((j)object0).h) == 0 : false;
    }
