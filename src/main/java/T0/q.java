...
public final class q extends A {
    ...
    public q(float f, float f1, float f2, boolean z, boolean z1, float f3, float f4) {
        super(3, false, false);
        this.c = f;
        this.d = f1;
        this.e = f2;
    ...
    public final boolean equals(Object object0) {
        ...
        if(Float.compare(this.c, ((q)object0).c) != 0) {
            return false;
        }
        if(Float.compare(this.d, ((q)object0).d) != 0) {
            return false;
        }
        if(Float.compare(this.e, ((q)object0).e) != 0) {
            return false;
        }
        ...
        return Float.compare(this.h, ((q)object0).h) == 0 ? Float.compare(this.i, ((q)object0).i) == 0 : false;
    }
