...
public final class b5 implements Adapter {
    public static final b5 a;
    public static final List b;

    static {
        b5.a = new b5();  // initializer: Ljava/lang/Object;-><init>()V
        b5.b = q.L(new String[]{"type", "frequency"});
    }
    ...
    alab1:
        while(true) {
            switch(jsonReader0.selectName(b5.b)) {
                case 0: {
        ...
        return new S4(userOverdraftChargeFrequency0, userOverdraftChargeType0);
    }
    ...
    public final void toJson(JsonWriter jsonWriter0, CustomScalarAdapters customScalarAdapters0, Object object0) {
        ...
        jsonWriter0.value(((S4)object0).a.a());
        jsonWriter0.name("frequency");
        jsonWriter0.value(((S4)object0).b.a());
    }
}
