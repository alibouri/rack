...
public final class e5 implements Adapter {
    ...
    static {
        ...
        e5.b = q.L(new String[]{"type", "frequency"});
    }
    ...
    alab1:
        while(true) {
            switch(jsonReader0.selectName(e5.b)) {
                case 0: {
        ...
        return new V4(userOverdraftChargeFrequency0, userOverdraftChargeType0);
    }
    ...
    public final void toJson(JsonWriter jsonWriter0, CustomScalarAdapters customScalarAdapters0, Object object0) {
        ...
        jsonWriter0.value(((V4)object0).a.a());
        jsonWriter0.name("frequency");
        jsonWriter0.value(((V4)object0).b.a());
    }
}
