...
public final class c4 implements Adapter {
    ...
    static {
        ...
        c4.b = q.L(new String[]{"formula", "label"});
    }
    ...
    alab1:
        while(true) {
            switch(jsonReader0.selectName(c4.b)) {
                case 0: {
    ...
    public final void toJson(JsonWriter jsonWriter0, CustomScalarAdapters customScalarAdapters0, Object object0) {
        ...
        String s = c.V(((V3)object0).a.Y);
        j.e(s, "toJSONString(...)");
        jsonWriter0.value(s);
        jsonWriter0.name("label");
        Adapters.StringAdapter.toJson(jsonWriter0, customScalarAdapters0, ((V3)object0).b);
    }
}
