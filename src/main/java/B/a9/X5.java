...
public final class x5 implements Adapter {
    ...
    static {
        ...
        x5.b = q.L(new String[]{"title", "text"});
    }
    ...
    alab1:
        while(true) {
            switch(jsonReader0.selectName(x5.b)) {
                case 0: {
    ...
    public final void toJson(JsonWriter jsonWriter0, CustomScalarAdapters customScalarAdapters0, Object object0) {
        ...
        Adapters.StringAdapter.toJson(jsonWriter0, customScalarAdapters0, ((w5)object0).a);
        jsonWriter0.name("text");
        Adapters.StringAdapter.toJson(jsonWriter0, customScalarAdapters0, ((w5)object0).b);
    }
}
