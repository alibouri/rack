...
public final class n2 implements Adapter {
    ...
    static {
        ...
        n2.b = q.L(new String[]{"sendAmount", "clientId", "billType", "whenCreated"});
    }
    ...
    alab1:
        while(true) {
            switch(jsonReader0.selectName(n2.b)) {
                case 0: {
        ...
        return new t4(currencyAmount0, s, s1, date0);
    }
    ...
    public final void toJson(JsonWriter jsonWriter0, CustomScalarAdapters customScalarAdapters0, Object object0) {
        ...
        j.f(((t4)object0).a, "value");
        String s = ((t4)object0).a.k();
        j.e(s, "toSerialized(...)");
        jsonWriter0.value(s);
        jsonWriter0.name("clientId");
        Adapters.StringAdapter.toJson(jsonWriter0, customScalarAdapters0, ((t4)object0).b);
        jsonWriter0.name("billType");
        Adapters.StringAdapter.toJson(jsonWriter0, customScalarAdapters0, ((t4)object0).c);
        jsonWriter0.name("whenCreated");
        u1.a.b(jsonWriter0, customScalarAdapters0, ((t4)object0).d);
    }
}
