...
public final class u3 implements Adapter {
    public static final u3 a;
    public static final List b;

    static {
        u3.a = new u3();  // initializer: Ljava/lang/Object;-><init>()V
        u3.b = q.L(new String[]{"__typename", "id"});
    }
    ...
    alab1:
        while(true) {
            switch(jsonReader0.selectName(u3.b)) {
                case 0: {
        ...
        return new M5(s, s1, paymentCardsFragment0);
    }
    ...
    public final void toJson(JsonWriter jsonWriter0, CustomScalarAdapters customScalarAdapters0, Object object0) {
        ...
        jsonWriter0.name("id");
        Adapters.StringAdapter.toJson(jsonWriter0, customScalarAdapters0, ((M5)object0).b);
        PaymentCardsFragmentImpl_ResponseAdapter.PaymentCardsFragment.b(jsonWriter0, customScalarAdapters0, ((M5)object0).c);
    }
}
